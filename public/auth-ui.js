...
(function () {
  ...
  var CSS =
    ...
    '.mood-auth-brand{position:absolute;left:24px;bottom:20px;z-index:4;font-family:\'Cormorant Garamond\',serif;font-weight:300;font-size:1.4rem;letter-spacing:.16em;color:#fdf6ee;text-transform:uppercase;text-shadow:0 2px 14px rgba(0,0,0,.5)}' +
