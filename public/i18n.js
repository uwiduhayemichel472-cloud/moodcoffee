...
const I18N = (function () {
  ...
  const DICT = {
    en: {
      ...
      co_pay_on_delivery_tag: 'Pay at the counter or when your order arrives',
      co_pay_on_delivery_note: 'Online payment is switched off — payment is collected at the shop.',
    ...
    fr: {
      ...
      co_pay_on_delivery_tag: 'Payez au comptoir ou à la livraison de votre commande',
      co_pay_on_delivery_note: 'Le paiement en ligne est désactivé — le paiement est collecté au magasin.',
    ...
    rw: {
      ...
      co_pay_on_delivery_tag: 'Kwishyura kuri kawunta cyangwa iyo ikintu cyawe kigeze',
      co_pay_on_delivery_note: 'Kwishyura kuri interineti ntibikora — kwishyura gukorwa mu iduka.',
